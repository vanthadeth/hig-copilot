...
export default function Dashboard() {
  ...
  return (
    <>
      <Head>
        <title>Dashboard - Footprints</title>
      ...
      <div className="flex flex-col h-screen bg-gray-900 text-white">
        ...
        <div className="bg-gray-800 border-t border-gray-700 flex items-center justify-around">
          ...
          <button
            ...
            className="flex-1 flex flex-col items-center justify-center py-4 transition-colors text-blue-500 border-t-2 border-blue-500"
          >
          ...
          <button
            ...
            className="flex-1 flex flex-col items-center justify-center py-4 transition-colors text-gray-400 hover:text-gray-300"
          >
            <svg className="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
